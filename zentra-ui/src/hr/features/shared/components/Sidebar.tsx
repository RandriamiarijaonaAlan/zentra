...
export default function Sidebar() {
  ...
  const [openModules, setOpenModules] = useState<string[]>(['QCM', 'Entretiens', 'Candidatures', 'Personnel', 'Paie', 'Congés', 'Compétences', 'Formations']);
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          path: '/admin/employee-skills/assign',
          icon: (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        {
          label: 'Compétences par employé',
          path: '/admin/employee-skills',
          icon: (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    },
    {
      ...
      children: [
        ...
        {
          label: 'Suggestions',
          path: '/admin/trainings/suggestions',
          icon: (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <circle cx="12" cy="12" r="10"></circle>
